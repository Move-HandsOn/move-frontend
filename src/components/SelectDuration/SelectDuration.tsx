        ...
        <div className={style.modalContent}>
          ...
          <div className={style.container}>
            <div className={style.display} onWheel={handleWheelHour}>
              ...
              <div
                className={`${style.hoursSelect} ${isAnimatingHour ? style.animate : ''}`}
              >
            ...
            <div className={style.display} onWheel={handleWheelMinutes}>
              <div className={style.minutesBefore}>
                {formatMinute(previousMinute)}
              </div>
              <div className={style.line} />
              <div
                className={`${style.minutesSelect} ${isAnimatingMinute ? style.animate : ''}`}
              >
                <div>{formatMinute(selectedMinute)}</div>
                <div>M</div>
              </div>
              <div className={style.line} />
              <div className={style.minutesAfter}>
                {formatMinute(afterMinute)}
              </div>
            </div>
          </div>
          <Button
